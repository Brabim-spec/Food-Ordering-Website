<?php
 ...
 ?>
 <?php 
    // check whthere id is set or not 
    if(isset($_GET['id'])){
       //get all the details
    	$id = $_GET['id'];
    	//sql query to get the selected folder
    	$sql2= "SELECT * FROM lbl_food WHERE id=$id";
    	//execute the query
    	...
    	//get the individualvalues of selected food 
              ...
              if(isset($_POST['submit'])){
                ...
                // check whether the upload button is clicked or not 
              	  if(isset($_FILES['image']['name'])){
                        ...
                        // 3. remove the image id image is uploaded and current image exists
